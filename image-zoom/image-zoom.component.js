...
// const View = react_native_1.View;
// const Animated = react_native_1.Animated;
// const TouchableOpacity = react_native_1.TouchableOpacity;
...
class ImageViewer extends React.Component {
    constructor() {
        ...
        this.zoomRate = this.props.zoomRate || 0.5;
    }
    componentWillMount() {
    ...
    zoomIn() {
        this.zoomInOut(this.scale + this.zoomRate);
    }
    zoomOut() {
        this.zoomInOut(this.scale - this.zoomRate);
    }
    ...
    render() {
        ...
        return (
            <View style={[{justifyContent: 'center',
                ...
                {/*<TouchableOpacity onPressIn={()=>{alert('sdfsd')}}>
                    <View style={{width: 100, height: 100,backgroundColor:'yellow'}}>
                        <Text>sjdlfkjsdflj</Text>
                    </View> 
                </TouchableOpacity>*/}
            </View>
        )

        return (React.createElement(react_native_1.View, Object.assign({ style: [image_zoom_style_1.default.container, { width: this.props.cropWidth, height: this.props.cropHeight }] }, this.imagePanResponder.panHandlers),
